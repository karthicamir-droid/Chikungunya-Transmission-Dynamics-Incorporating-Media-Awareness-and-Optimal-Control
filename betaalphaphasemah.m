...
%% Maharashtra baseline parameter (median)
kappa_med  = 0.12416;
epsilon_med = 0.92278;
gamma_med   = 0.0762;
eta_med     = 0.85791;
...
kappa_CI   = [0.109 0.139];
epsilon_CI = [0.862 0.984];
gamma_CI   = [0.063 0.089];
eta_CI     = [0.821 0.895];
tau_CI     = [0.409 0.481];
delta_CI   = [0.048 0.061];

%% Parameter grids
alpha = linspace(0,0.2730,150);   % recovery rate (rows)
beta  = linspace(0,0.1207,150);   % transmission rate (cols)
...
title('\bf Maharashtra: Safe (Green) vs Epidemic (Red) Regions','FontSize',14,'FontWeight','bold');
