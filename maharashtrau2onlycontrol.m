...
% Initial conditions
Su(1)=60439692; Sa(1)=1000000; Eh(1)=2500; Ia(1)=469; Is(1)=207;
R(1)=3000; Me(1)=37510300; Sv(1)=49638138; Ev(1)=7802; Iv(1)=1300;
...
title('Optimal control vs No control : Maharashtra', 'fontsize',15');
