...
[T1, X1] = ode15s(@(t,x) kar(t,x,0.88633), tspan, xnot); 
[T2, X2] = ode15s(@(t,x) kar(t,x,0.93633), tspan, xnot); 
[T3, X3] = ode15s(@(t,x) kar(t,x,0.98633), tspan, xnot); 
...
legend('\eta = 0.88633', '\eta = 0.93633', '\eta = 0.98633');
