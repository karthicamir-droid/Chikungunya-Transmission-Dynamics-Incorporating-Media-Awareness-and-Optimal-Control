...
while(test1 > delta1)
    ...
    for i=1:M
        ...
        m5 = (1-kappa)*epsilon*Eh(i) - (alpha+mu_h+mu2)*Is(i);
        m6 = gamma*Ia(i) + alpha*Is(i) - mu_h*R(i);
...
tspan=[0 T];
[Twc, Zwc]=ode15s(@(t,z) model_withcontrol(t,z,u1_fun),tspan,znot);
...
function dz=model_withoutcontrol(t,z)
    ...
    kappa=0.46312; epsilon=0.93459; gamma=0.76959;
    alpha=0.18012; eta=0.54376; beta=0.10259;
    tau=0.48077; delta=0.74591;
...
function dz=model_withcontrol(t,z,u1_fun)
    % Parameters
